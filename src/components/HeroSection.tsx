    ...
    <section className="hero-gradient pt-20 pb-32 px-4">
      <div className="container mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="bg-white dark:bg-card shadow-lg p-3 rounded-full">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-searchifi-purple to-searchifi-light-purple grid place-items-center animate-float">
                <Search className="text-white" size={28} />
              </div>
            </div>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-searchifi-purple to-searchifi-light-purple">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/register">
              <Button variant="outline" className="px-8 py-6 text-lg border-searchifi-purple text-searchifi-purple hover:bg-searchifi-purple/10">
                Share Your Project
              </Button>
            </Link>
          </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="bg-white dark:bg-card rounded-xl p-6 shadow-md border border-border">
            <div className="w-12 h-12 rounded-lg bg-searchifi-purple/10 grid place-items-center mb-4">
          ...
          <div className="bg-white dark:bg-card rounded-xl p-6 shadow-md border border-border">
            <div className="w-12 h-12 rounded-lg bg-searchifi-purple/10 grid place-items-center mb-4">
              <Eye className="text-searchifi-purple" size={24} />
            </div>
